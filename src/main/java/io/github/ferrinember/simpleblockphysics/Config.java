...
public class Config
{
    ...
    {
        return obj instanceof final String blockName && ForgeRegistries.BLOCKS.containsKey(ResourceLocation.tryParse(blockName));
    }


    private static boolean validateTagName(final Object obj)
    {
        return obj instanceof final String tagName && ForgeRegistries.BLOCKS.tags().isKnownTagName(ForgeRegistries.BLOCKS.tags().createTagKey(ResourceLocation.tryParse(tagName)));
    }
    ...
    static void onLoad(final ModConfigEvent event)
    {
        ...
        allowedDimensions = ALLOWED_DIMENSIONS.get().stream()
                .map(dimName -> ResourceKey.create(Registries.DIMENSION,ResourceLocation.tryParse(dimName)))
                .collect(Collectors.toSet());
        ...
        overwrittenBlockTags = OVERWRITE_TAG_STRINGS.get().stream()
                .map(tagName -> ForgeRegistries.BLOCKS.tags().createTagKey(ResourceLocation.tryParse(tagName)))
